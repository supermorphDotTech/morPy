...
class cl_orchestrator:
    ...
    def _app_run(self, morPy_trace: dict, app_dict: dict):
        ...
        try:
            ...
            app_init_return = _init(morPy_trace, app_dict)["app_init_return"]
            app_run_return = _run(morPy_trace, app_dict, app_init_return)["app_run_return"]

            # Exit the app and signal morPy to exit
            _exit(morPy_trace, app_dict, app_run_return, self)
