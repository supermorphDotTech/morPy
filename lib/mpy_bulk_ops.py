...
def find_replace_saveas(
    ...
    :example:
        ...
        overwrite = True
        retval = find_replace_saveas(mpy_trace, prj_dict, search_obj, replace_tpl, save_as, overwrite)
    """
    ...
    try:
        # Operation start.
        mpy_msg.log(mpy_trace, prj_dict, prj_dict["find_replace_saveas_start"], 'debug')
        ...
        if file_exists and not overwrite:
            ...
            mpy_msg.log(mpy_trace, prj_dict, prj_dict["find_replace_saveas_f_ex_skip"], 'warning')
        else:
            ...
            if not isinstance(replace_tpl[0], tuple):
                ...
                log_message = (
                    f'{prj_dict["loc"]["mpy"]["find_replace_saveas_tpl_err"]}\n'
