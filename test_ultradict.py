...
def u_dict_build(create: bool=False):
    ...
    app_dict["nested_udict"]["lvl2"] = UltraDict(
        name="nested_udict[lvl2]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2"]["lvl3"] = UltraDict(
        name="nested_udict[lvl2][lvl3]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2"]["lvl3"]["lvl4"] = UltraDict(
        name="nested_udict[lvl2][lvl3][lvl4]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2_add1"] = UltraDict(
        name="nested_udict[lvl2_add1]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2_add2"] = UltraDict(
        name="nested_udict[lvl2_add2]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2_add3"] = UltraDict(
        name="nested_udict[lvl2_add3]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2_add4"] = UltraDict(
        name="nested_udict[lvl2_add4]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    app_dict["nested_udict"]["lvl2_add5"] = UltraDict(
        name="nested_udict[lvl2_add5]",
        create=create,
        shared_lock=True,
        buffer_size=1_000_000,
        full_dump_size=1_000_000,
    ...
    try:
        ...
        while i < total:
            ...
            with app_dict["nested_udict"].lock:
                ...
                app_dict["nested_udict"]["lvl2"]["test_count"] += 1
                app_dict["nested_udict"]["lvl2"]["lvl3"]["test_count"] += 1
                app_dict["nested_udict"]["lvl2"]["lvl3"]["lvl4"]["test_count"] += 1

            print(
                f'{process.name} \n>>> {app_dict["test_count"]} :: {app_dict["nested_udict"]["test_count"]} :: '
                f'{app_dict["nested_udict"]["lvl2"]["test_count"]} :: '
                f'{app_dict["nested_udict"]["lvl2"]["lvl3"]["test_count"]} :: '
                f'{app_dict["nested_udict"]["lvl2"]["lvl3"]["lvl4"]["test_count"]}\n'
                f'>>> fibonacci={len(fib_seq)}\n'
            )
            while tmp_val < total:
...
if __name__ == '__main__':
    ...
    app_dict["nested_udict"]["lvl2"]["test_count"] = 0
    app_dict["nested_udict"]["lvl2"]["lvl3"]["test_count"] = 0
    app_dict["nested_udict"]["lvl2"]["lvl3"]["lvl4"]["test_count"] = 0
