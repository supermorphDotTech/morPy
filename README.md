...
<br/>`1.1` [Microsoft Windows](#1.1)  
<br/>`1.1.1` [Software Requirements](#1.1.1)  
<br/>`1.1.2` [Setup Guidance](#1.1.2)  
<br/>`1.1.3` [Virtual Environment](#1.1.3)  
<br/>`1.1.3.1` [Basic Setup](#1.1.3.1)  
<br/>`1.1.3.2` [Install Dependencies](#1.1.3.2)  
<br/>`1.1.3.3` [Copy Packages to Virtual Environment](#1.1.3.3)  
<br/>`2.` [Versioning - α.β.γλ](#2.)  
<br/>`3.` [Parallelization](#3.)  
<br/>`4.` [≛ Shared App Dictionary](#4.)  
<br/>`4.1` [Introduction](#4.1)  
<br/>`4.2` [Navigating the App Dictionary](#4.2)  
<br/>`4.2.1` [Categorization & Sub-Dictionaries](#4.2.1)  
<br/>`4.2.2` [App Dictionary Map](#4.2.2)  
<br/>`5.` [Dependency Visualization](#5.)  
<br/>`5.1` [Setup Dependency Visualization (Microsoft Windows)](#5.1)  
<br/>`5.2` [Visualize Dependencies (Microsoft Windows)](#5.2)  
<br/>`6.` [Abbreviations](#6.)
